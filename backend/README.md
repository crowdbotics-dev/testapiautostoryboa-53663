...
## Project Structure
    ...
    ├── testapiautostoryboa_53663  # Django project configurations
...
1. Clone this repo and `cd testapiautostoryboa_53663`
...
2. Clone this repo and `cd testapiautostoryboa_53663`
